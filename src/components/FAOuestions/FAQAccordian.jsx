  ...
  return (
    <>
      <div id="accordionExample ">
        <div className="rounded-t-lg m-2 border border-neutral-200 bg-green-100 dark:border-neutral-600 dark:bg-neutral-800">
          <h2 className="mb-0" id="headingOne">
            <button
              className={`${
                activeElement === "element1" &&
                `text-primary font-medium [box-shadow:inset_0_-1px_0_rgba(229,231,235)] dark:!text-primary-400 dark:[box-shadow:inset_0_-1px_0_rgba(75,85,99)]`
              } group relative flex w-full items-center rounded-t-[15px] border-0 bg-green-100 px-5 py-4 text-left text-base text-neutral-800 transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none dark:bg-neutral-800 dark:text-white`}
              type="button"
      ...
      <div className="border m-2 border-t-0 border-neutral-200 bg-green-100 dark:border-neutral-600 dark:bg-neutral-800">
      ...
      <div className="rounded-b-lg m-2 border border-t-0 border-neutral-200 bg-green-100 dark:border-neutral-600 dark:bg-neutral-800">
